...
var AsyncCollection = (function (_Backbone$Collection) {
  _inherits(AsyncCollection, _Backbone$Collection);

  function AsyncCollection(options) {
    _classCallCheck(this, AsyncCollection);

    _get(Object.getPrototypeOf(AsyncCollection.prototype), 'constructor', this).call(this, options);
    this.config = _config2['default'].getInstance();
  }

  _createClass(AsyncCollection, [{
    key: 'init',
    value: function init() {
      var _this = this;
      ...
      this.fetch().success(function () {
        ...
        defer.reject(new Error('Unable to fetch data for ' + _this.name + ': ' + error));
      });
      return defer.promise;
    }
  }, {
    key: 'addAndSync',
    value: function addAndSync(method, model, options) {
      var newModel = this.add(model, options);
      var defer = _q2['default'].defer();
      _backbone2['default'].sync(method, newModel).success(function () {
...
var LocationCollection = (function (_AsyncCollection) {
  _inherits(LocationCollection, _AsyncCollection);

  function LocationCollection(options) {
    _classCallCheck(this, LocationCollection);

    _get(Object.getPrototypeOf(LocationCollection.prototype), 'constructor', this).call(this, options);
...
var MemberCollection = (function (_AsyncCollection) {
  _inherits(MemberCollection, _AsyncCollection);

  function MemberCollection(options) {
    _classCallCheck(this, MemberCollection);

    _get(Object.getPrototypeOf(MemberCollection.prototype), 'constructor', this).call(this, options);
...
var RecordCollection = (function (_AsyncCollection) {
  ...
  function RecordCollection(options) {
    _classCallCheck(this, RecordCollection);

    _get(Object.getPrototypeOf(RecordCollection.prototype), 'constructor', this).call(this, options);
...
var _templatesMainHtml = require('./templates/main.html');

var _templatesMainHtml2 = _interopRequireDefault(_templatesMainHtml);

var _events = require('./events');

var _events2 = _interopRequireDefault(_events);

var _modelsMap = require('./models/map');

var _modelsMap2 = _interopRequireDefault(_modelsMap);

var _modelsSearch = require('./models/search');

var _modelsSearch2 = _interopRequireDefault(_modelsSearch);

var _modelsInfo = require('./models/info');

var _modelsInfo2 = _interopRequireDefault(_modelsInfo);

var _viewsMap = require('./views/map');

var _viewsMap2 = _interopRequireDefault(_viewsMap);

var _viewsToolbar = require('./views/toolbar');
...
var _viewsInfo2 = _interopRequireDefault(_viewsInfo);

var _viewsAlert = require('./views/alert');

var _viewsAlert2 = _interopRequireDefault(_viewsAlert);
...
var CSHMap = (function () {
  function CSHMap(config) {
    _classCallCheck(this, CSHMap);
  ...
  _createClass(CSHMap, [{
    ...
    value: function _initModels() {
      this.mapModel = new _modelsMap2['default']({
        config: this.config
      });
      this.searchModel = new _modelsSearch2['default']({
        config: this.config,
        map: this.mapModel
      });
      this.infoModel = new _modelsInfo2['default']({
        config: this.config,
        map: this.mapModel
      });
    }
    ...
    value: function _initViews() {
      (0, _jquery2['default'])(SELECTORS.WRAPPER).html(_templatesMainHtml2['default']);
      this.mapView = new _viewsMap2['default']({
        model: this.mapModel
      });
    ...
    value: function _render() {
      return this._loadMapDataAndRender().then(this._renderToolbar.bind(this)).then(this._renderSearchModal.bind(this)).then(this._renderInfoModal.bind(this))['catch'](function (error) {
        console.error(error);
      });
    }
  }, {
    key: '_loadMapDataAndRender',
    value: function _loadMapDataAndRender() {
      return this.mapModel.init().then(this._renderMap.bind(this));
    }
  }, {
    key: '_renderMap',
    value: function _renderMap() {
      (0, _jquery2['default'])(SELECTORS.MAP).html(this.mapView.render().el);
    }
  }, {
    key: '_renderToolbar',
    value: function _renderToolbar() {
      (0, _jquery2['default'])(SELECTORS.TOOLBAR).html(this.toolbarView.render().el);
    }
  }, {
    ...
    key: '_showAlert',
    value: function _showAlert(type, message) {
      this.alertView.setData(type, message);
      (0, _jquery2['default'])(SELECTORS.ALERT).html(this.alertView.render().el);
    }
  }]);
...
var MapEvents = _underscore2['default'].extend({}, _backbone2['default'].Events);
...
var InfoModel = (function (_Backbone$Model) {
  ...
  function InfoModel(attributes, options) {
    _classCallCheck(this, InfoModel);

    _get(Object.getPrototypeOf(InfoModel.prototype), 'constructor', this).call(this, attributes, options);
  ...
  _createClass(InfoModel, [{
    ...
    key: 'loadDataFromMap',
    value: function loadDataFromMap() {
      var member = this.get('map').get('members').findWhere({ uid: this.get('config').uid });
      if (!member) return;
      var record = this.get('map').get('records').findWhere({ MemberUid: member.get('uid') });
      if (!record) return;
      var location = this.get('map').get('locations').findWhere({ id: record.get('LocationId') });
      if (!location) return;
      var parts = location.get('address').split(', ');
      this.set({
        member: member,
        record: record,
        location: location,
    ...
    value: function updateAddress() {
      var address = this.get('city') + ', ' + this.get('state') + ', ' + this.get('country');
      return this._geocodeAddress(address).then(this._createOrGetMember.bind(this)).then(this._createOrGetLocation.bind(this)).then(this._createMoveRecord.bind(this)).then(this.loadDataFromMap.bind(this));
    }
  }, {
    key: 'removeFromMap',
    value: function removeFromMap() {
      return this._removeMember().then(this.defaults.bind(this));
    }
  }, {
    key: '_geocodeAddress',
    value: function _geocodeAddress(address) {
      var _this = this;

      var defer = _q2['default'].defer();
      this.geocoder.geocode({ address: address }, function (results, status) {
        if (status === google.maps.GeocoderStatus.OK) {
          _this.geocodeResult = results[0];
          defer.resolve();
        } else {
    ...
    key: '_createOrGetMember',
    value: function _createOrGetMember() {
      var _this2 = this;
      ...
      if (!member) {
        var _ret = (function () {
          var defer = _q2['default'].defer();
          member = {
            uid: _this2.get('config').uid,
            cn: _this2.get('config').cn
          };
          member = _this2.get('map').get('members').add(member);
          member.sync('create', member).success(function (response) {
            member.set(response);
            _this2.updateData.member = member;
            defer.resolve();
          }).error(function (error) {
            defer.reject(error);
          });
    ...
    key: '_createOrGetLocation',
    value: function _createOrGetLocation() {
      var _this3 = this;

      var location = this.get('map').get('locations').findWhere({
      ...
      if (!location) {
        var _ret2 = (function () {
          var defer = _q2['default'].defer();
          location = {
            address: _this3.geocodeResult.formatted_address,
            latitude: _this3.geocodeResult.geometry.location.lat(),
            longitude: _this3.geocodeResult.geometry.location.lng()
          };
          location = _this3.get('map').get('locations').add(location);
          location.sync('create', location).success(function (response) {
            location.set(response);
            _this3.updateData.location = location;
            defer.resolve();
          }).error(function (error) {
            defer.reject(error);
          });
    ...
    key: '_createMoveRecord',
    value: function _createMoveRecord() {
      var _this4 = this;
    ...
    value: function _removeMember() {
      var uid = this.get('member').get('uid');
      var record = {
        MemberUid: uid,
        LocationId: -1,
        ReasonId: this.get('reason')
...
var _collectionsRecords = require('../collections/records');
...
var MapModel = (function (_Backbone$Model) {
  ...
  function MapModel(attributes, options) {
    _classCallCheck(this, MapModel);

    _get(Object.getPrototypeOf(MapModel.prototype), 'constructor', this).call(this, attributes, options);
  ...
  _createClass(MapModel, [{
    ...
    key: '_initError',
    value: function _initError(error) {
      console.error(error);
    }
  }, {
    key: '_ready',
    ...
    value: function _createMarkers() {
      ...
      this.get('records').each(function (record) {
        ...
        var member = _this.get('members').findWhere({ uid: memberUid }).toJSON();
        var location = _this.get('locations').findWhere({ id: locationId }).toJSON();
    ...
    value: function _destroyMarkers() {
      _underscore2['default'].each(this.get('markers'), function (marker) {
...
var SearchModel = (function (_Backbone$Model) {
  ...
  function SearchModel(attributes, options) {
...
var _templatesAlertHtml = require('../templates/alert.html');

var _templatesAlertHtml2 = _interopRequireDefault(_templatesAlertHtml);
...
var AlertView = (function (_Backbone$View) {
  ...
  function AlertView(options) {
    ...
    _get(Object.getPrototypeOf(AlertView.prototype), 'constructor', this).call(this, options);
    this.template = _underscore2['default'].template(_templatesAlertHtml2['default']);
    this.data = {};
  }
  ...
  _createClass(AlertView, [{
    ...
    key: 'setData',
    value: function setData(type, message) {
      this.data = {
        type: type,
        message: message
      };
...
var InfoView = (function (_ModalContentView) {
  ...
  function InfoView(options) {
    ...
    _get(Object.getPrototypeOf(InfoView.prototype), 'constructor', this).call(this, options);
    this.events = {
  ...
  _createClass(InfoView, [{
    ...
    key: '_onEditCity',
    value: function _onEditCity(event) {
      this._submitOrUpdate(event, 'city');
    }
  }, {
    key: '_onEditState',
    value: function _onEditState(event) {
    ...
    value: function _onSubmit() {
      this.model.updateAddress().then(this._onSubmitSuccess.bind(this))['catch'](this._onError.bind(this)).done();
    }
  }, {
    key: '_onSubmitSuccess',
    ...
    value: function _onRemove() {
      this.model.removeFromMap().then(this._onRemoveSuccess.bind(this))['catch'](this._onError.bind(this)).done();
    }
  }, {
...
var _templatesInfoWindowHtml = require('../templates/info-window.html');

var _templatesInfoWindowHtml2 = _interopRequireDefault(_templatesInfoWindowHtml);

var MapView = (function (_Backbone$View) {
  _inherits(MapView, _Backbone$View);

  function MapView(options) {
    _classCallCheck(this, MapView);

    _get(Object.getPrototypeOf(MapView.prototype), 'constructor', this).call(this, options);
    this.gmapOptions = {
      zoom: 4,
    ...
    this.gmap = null;
    this._infoWindowTemplate = _underscore2['default'].template(_templatesInfoWindowHtml2['default']);
  }
  ...
  _createClass(MapView, [{
    ...
    key: '_createGoogleMapsMarkers',
    value: function _createGoogleMapsMarkers() {
      var _this = this;

      var markers = this.model.get('markers');
      _underscore2['default'].each(markers, function (marker) {
        var decorator = _this._createGoogleMapsDecorator(marker);
        _underscore2['default'].extend(marker, decorator);
      });
    }
  }, {
    key: '_createGoogleMapsDecorator',
    value: function _createGoogleMapsDecorator(marker) {
      var _this2 = this;
...
var SearchView = (function (_ModalContentView) {
  ...
  _createClass(SearchView, [{
    ...
    key: '_debounceSearch',
    value: function _debounceSearch(e) {
      var _this = this;
...
var _templatesToolbarHtml = require('../templates/toolbar.html');

var _templatesToolbarHtml2 = _interopRequireDefault(_templatesToolbarHtml);

var ToolbarView = (function (_Backbone$View) {
  _inherits(ToolbarView, _Backbone$View);
  ...
  function ToolbarView(options) {
    ...
    this.template = _underscore2['default'].template(_templatesToolbarHtml2['default']);
  }
